...
<body>
    ...
    <section class="container py-2">
    	...
    	// it most most impoetant here .... here only these allowed which has status is pending ....
    	// if someonces status is not pending it will be not allowed here ... 
    	// if we change it status from pending to activated it will not seen here ...on AdminHome.jsp ...
   		AdminDao db=new AdminDao();
   		ArrayList<HashMap> allGarage=db.getGarageByStatus("pending"); // here is a condition only pending allowed here .. 
